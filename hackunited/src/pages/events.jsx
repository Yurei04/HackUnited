...
export default function Events () {
    ...
    return (
        <div className="flex flex-col w-full min-h-screen mt-20 p-5" id="Events">
            <motion.div
            ...
            <div className="h-2xl flex-1 rounded-xl sm:h-sm">
                {current.currentEvent.map((event) => (
                    ...
                    >
                        <CardHeader>
                            <CardTitle className="text-purple-200 text-3xl flex items-center gap-2">
                        ...
                        <CardContent className=" space-x-10 flex lg:flex-row sm:flex-col">
                            <div className="text-justify justify-between text-sm">
                                    <p className="text-justify text-purple-300">{event.des}</p>
                                    <br />
                                ...
                                <div className="pt-4">
                                    <Button
                                        className="bg-purple-600 hover:bg-purple-500 text-purple-200 cursor-pointer"
                ...
                {chartData.dataset.map((cards) => (
                    ...
                    <CardContent className="space-y-2 text-xs">
                        ...
                        <div className="flex flex-wrap gap-4 pt-4 ">
                            <Button
                                className="bg-purple-600 hover:bg-purple-500 text-purple-200 flex items-center gap-2 cursor-pointer"
                            ...
                            <Button
                                className="bg-purple-500 hover:bg-purple-700 text-purple-200 flex items-center gap-2 cursor-pointer"
