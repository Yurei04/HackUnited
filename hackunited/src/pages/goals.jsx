        ...
        <div className="flex lg:flex-row md:flex-col gap-12 max-w-7xl mx-auto items-center justify-center">
          <AnimatedCard direction="left" justify="start">
            <Card className="bg-black/60 backdrop-blur-md max-w-xl p-8">
              <CardContent>
                <h2 className="flex items-center gap-3 text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-400 to-purple-500 mb-4">
                  <CodeXml className="w-7 h-7" />
                  Accelerating Soft Skills
                </h2>
                <Separator className="bg-purple-700 mb-6" />
