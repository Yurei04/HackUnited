...
export default function About () {
    return (
        <div className="w-full min-h-screen p-1 flex lg:flex-col sm:flex-col items-center justify-center sm:mt-25" id="About">
            <motion.div
            ...
            >
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div>
                        <motion.div
                            ...
                            whileTap={{ scale: 0.5 }}
                            className="relative sm:w-64 sm:h-64 lg:w-72 lg:h-72 rounded-full border border-purple-700 bg-[#181818] overflow-hidden"
                        >
                            <Image
                ...
                <Card className="text-justify p-5 isolate aspect-video lg:w-2xl sm:w-lg  rounded-xl bg-black/50 shadow-lg ring-1 ring-black/5 hover:border-purple-500">
                    <CardContent>
