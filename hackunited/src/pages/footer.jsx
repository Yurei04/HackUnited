...
export default function Footer() {
  return (
    <footer className="bg-black/80 border-t border-purple-900 text-purple-300 px-6 py-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="flex lg:flex-col sm:flex-col space-y-3 text-center md:text-left lg:items-start sm:items-center sm:justify-center">
          ...
          <p className="text-sm text-purple-400">
            Hack United is fiscally sponsored by Hack Club Bank,<br />
        ...
        <div className="flex flex-row items-center justify-center gap-2 text-sm">
          ...
          <Link href="/team" className="hover:text-purple-500 transition-colors">Team</Link>
          <Link href="/blog" className="hover:text-purple-500 transition-colors">Blog</Link>
          <Link href="/apply" className="hover:text-purple-500 transition-colors">Apply</Link>
          <Link href="/donate" className="hover:text-purple-500 transition-colors">Donate</Link>
        ...
        <div className="space-y-4 text-center md:text-right flex flex-col">
          <div>
            <p className="text-sm text-purple-400">Want updates?</p>
            <form className="mt-2 flex flex-col sm:flex-row gap-2 items-center justify-center md:justify-end">
              <input
                type="email"
                placeholder="you@example.com"
                className="px-3 py-2 rounded-lg bg-black border border-purple-700 text-sm text-purple-200 placeholder-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
              <button
                type="submit"
