      ...
      <div className="container lg:p-15 sm:p-5 mx-auto px-6 lg:px-12 flex flex-col-reverse lg:flex-row items-center justify-center gap-12">
        ...
        >
          ...
          <h2 className="mt-4 text-xl sm:text-2xl lg:text-3xl font-medium text-gray-200">
            Empowering tomorrow’s leaders through innovation, collaboration, and code.
          </h2>
        ...
        <motion.div
          ...
          className="relative w-64 h-64 lg:w-80 lg:h-80 rounded-full border-4 border-purple-700 bg-[#181818] shadow-lg overflow-hidden"
        >
          <Image
